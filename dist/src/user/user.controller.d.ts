...
export declare class UserController {
    ...
    getUserDailyStats(id: string, dateStr: string): Promise<any>;
    getUserMonthlyStats(id: string, year: string, month: string): Promise<any>;
    getUserStatsSummary(id: string): Promise<{
        user: {
            id: string;
            firstName: string;
            lastName: string;
